...
Source, license, and author for every scene preset registered via
`src/demo/scenes/presets/*`. Ports recreate the lighting setup of an existing
demo with simplified geometry (no external GLB/HDRI/animation loads).
