...
export declare function buildRaycastOpts(opts: ResolvedBakerOptions, resolution: number, lights: PackedLight[], skyColor: Color, matTex: MaterialTextures, tp: Required<TimeoutProtectionOptions>): RaycastOptions;
